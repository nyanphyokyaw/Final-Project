...
<head>
   ...
   <meta name="keywords" content="Burger, Pizza, Korea Food, Myanmar Food, Liquors">
	...
	<meta property="og:url" content="https://foodparadise.com/chicken.php" />
...
<body>
	...
	<h1  align="center" style="color:red;"><b>Fruit Drinks , Chicken , Duck</b></h1></br>
	
	 <?php
					 error_reporting(1);
					 include("connection.php");
						$sel=mysql_query("select * from chicken ");
 ...
 <b>product name:</b>".$arr['prod_no'].
  ...
  "<br><a href='chickenorder.php?img=$i'><b>Pick up</b></a>
