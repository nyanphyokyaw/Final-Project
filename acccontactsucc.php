...
<head>
	...
	<meta property="og:url" content="https://foodparadise.com/acccontactsucc.php" />
	<meta property="og:title" content="Account Contact Success" />
...
<body>
	...
	<!-- End header -->
		...
		<div class="container">
			...
			<br/><br/>
			<br/>
			<br/><p class="t">Thanks You.!! <br/>
			Your Feedback Message Has Been Successfully Sent.!!!</p>
			
			<p class="t">Thank You For Feedback.</p>
			<img src="images/t5.gif" width="200">
			<p class="t"><a href="?log=out">Confirm</a></p>
