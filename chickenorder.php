...
{
//echo "<script>location.href='chickensent.php?prod'</script>";
header("location:chickensent.php?order_no=$ordno");  }
...
<head>
	...
	<meta property="og:url" content="https://foodparadise.com/chickenorder.php" />
	<meta property="og:title" content="Chicken Order" />
