...
<head>
	...
	<meta property="og:url" content="https://foodparadise.com/account.php" />
...
<body>
	...
	<div class="all-page-title page-breadcrumb">
		<div class="container text-center">
			<div class="row">
				<div class="col-lg-12">
					<h1>Account</h1>
					<img src="images/myaccount.png" width="100">
				</div>
			</div>
		</div>
	</div>	
	...
	<div class="contact-box">
		...
		<h1 align="center">See Your Profile</h1>
		<img src="images/account.png" align="right" width="400">
		
		<p><b>သင့်အကောင့်ကို လုံခြုံ စိတ်ချအောင် ပြုလုပ်ထားပါသည်။
		</br>ကျွန်တော် တို့ website ကို အသုံးပြုခြင်း အတွက် ကျေးဇူးတယ်ပါသည်။
		</br>ကျွန်တော်တို့နှင့်အတူ ရေရှည် လက်တွဲ သွားနိုင်မယ်လို့လဲ ယုံကြည် မျှော်လင့်ပါသည်။
		</b></p>
		</br>
		
		<button onclick="document.getElementById('images').src='images/thank-you.gif'">Turn On</button>
		
		<img id="images" src="black.jpg" style="width:300px">
		
		<button onclick="document.getElementById('images').src='images/black.jpg'">Turn Off</button>
