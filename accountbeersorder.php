...
{
//echo "<script>location.href='accountbeerssent.php?prod'</script>";
header("location:accountbeerssent.php?order_no=$ordno");  }
...
<head>
	...
	<meta property="og:url" content="https://foodparadise.com/accountbeersorder.php" />
	<meta property="og:title" content="Account Beer S Order" />
...
<body>
	...
	<?php
			include("connection.php");
			$sel=mysql_query("select * from beersecond  where img='$i' ");
