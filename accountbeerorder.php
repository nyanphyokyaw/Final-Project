...
{
//echo "<script>location.href='accountbeersent.php?prod'</script>";
header("location:accountbeersent.php?order_no=$ordno");  }
...
<head>
   ...
   <meta name="keywords" content="Burger, Pizza, Korea Food, Myanmar Food, Liquors">
	...
	<meta property="og:url" content="https://foodparadise.com/accountbeersent.php" />
	<meta property="og:title" content="Account Beer Sent" />
...
<body>
	...
	<?php
			include("connection.php");
			$sel=mysql_query("select * from beer  where img='$i' ");
