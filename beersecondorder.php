...
{
//echo "<script>location.href='beersecondsent.php?prod'</script>";
header("location:beersecondsent.php?order_no=$ordno");  }
...
<head>
	...
	<meta property="og:url" content="https://foodparadise.com/beersecondorder.php" />
	<meta property="og:title" content="Beer Second Order" />
