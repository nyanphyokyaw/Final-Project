...
<head>
	...
	<meta property="og:url" content="https://foodparadise.com/myanmarsecond.php" />
	<meta property="og:title" content="Myanmar Second" />
...
<body>
	...
	<div class="col-12">
                        <ul class="pagination pagination-lg justify-content-center">
                           <li class="page-item"><a class="page-link" href="index.php">Previous</a></li>
                            ...
                            <li class="page-item"><a class="page-link" href="chicken.php">2</a></li>
                            <li class="page-item"><a class="page-link" href="koreachina.php">3</a></li>
							<li class="page-item"><a class="page-link" href="myanmar.php">4</a></li>
							<li class="page-item"><a class="page-link" href="myanmarsecond.php">5</a></li>
                            <li class="page-item"><a class="page-link" href="beer.php">6</a></li>
							<li class="page-item"><a class="page-link" href="beersecond.php">7</a></li>
                            <li class="page-item"><a class="page-link" href="next.php">Next</a></li>
                        </ul> 
                    </div></br>
	<h1  align="center" style="color:red;"><b>Myanmar Food 2</b></h1></br>
	
	 <?php
					 error_reporting(1);
					 include("connection.php");
						$sel=mysql_query("select * from myanmarsecond ");
 ...
 <b>product name:</b>".$arr['prod_no'].
  ...
  "<br><a href='myanmarsecondorder.php?img=$i'><b>Pick up</b></a>
