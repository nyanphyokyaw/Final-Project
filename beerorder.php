...
{
//echo "<script>location.href='beersent.php?prod'</script>";
header("location:beersent.php?order_no=$ordno");  }
...
<head>
   ...
   <meta name="keywords" content="Burger, Pizza, Korea Food, Myanmar Food, Liquors">
	...
	<meta property="og:url" content="https://foodparadise.com/beerorder.php" />
	<meta property="og:title" content="Beer Order" />
