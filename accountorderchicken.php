...
{
//echo "<script>location.href='accountsentchicken.php?prod'</script>";
header("location:accountsentchicken.php?order_no=$ordno");  }
...
<head>
	...
	<meta property="og:url" content="https://foodparadise.com/accountorderchicken.php" />
	<meta property="og:title" content="Account Order Chicken" />
...
<body>
	...
	<!-- End header -->
		...
		<div class="container text-center">
			<div class="row">
				<div class="col-lg-12">
					<h1>Chicken & Drink Order Form</h1>
				</div>
			</div>
		</div>
	</div>
	...
	<?php
			include("connection.php");
			$sel=mysql_query("select * from chicken  where img='$i' ");
