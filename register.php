...
<head>
	...
	<meta property="og:url" content="https://foodparadise.com/register.php" />
...
<!-- Start header -->
	...
	<div class="contact-box">
		<div class="container">
			...
			<img src="images/register2.gif" align="right" width="500">
            <?php
error_reporting(1);
...
$city=$_POST['t5'];
$town=$_POST['t6'];
if(mysql_query("insert into register(name,email,password,gender,birthday,phone,city,township) values('$name','$email','$password','$gender','$birthday','$phone','$city','$town')"))
{
...
?>
		<h1>Register Information</h1>
            <form  method="post">
                ...
                <input type="password" name="t3" id="t3" class="input_field" /><br/></br>
				<label>Gender : </label><br/>
				Male <input type="radio" name="ge" id="ge" value="Male"  />
				Female <input type="radio" name="ge" id="ge" value="Female"  /></br></br>
