...
{
//echo "<script>location.href='accountkoreasent.php?prod'</script>";
header("location:accountkoreasent.php?order_no=$ordno");  }
...
<head>
	...
	<meta property="og:url" content="https://foodparadise.com/accountkoreaorder.php" />
	<meta property="og:title" content="Account Korea Order" />
			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="navbars-rs-food">
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item"><a class="nav-link" href="accountregister.php">Register</a></li>
