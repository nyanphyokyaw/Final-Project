...
//echo"<script>location:href='login_success.php?img=$i'</script>";
header("location:login_success.php?img=$i"); 
}
...
<head>
	...
	<meta property="og:url" content="https://foodparadise.com/login.php" />
		...
		<div class="container">
			...
			<img src="images/login1.png">
                <form method="post" name="contact" action="#">
                      <div class="col_4 no_margin_right"></br>
                        <label for="phone">User Email:</label><br/>
                        <input type="email" id="id" name="id" class="required input_field" /><br/>
                    </div>
                    <div class="col_4 no_margin_right"><br/>
                        <label for="email">Password:</label><br/>
                        <input type="password" id="pwd" name="pwd" class="validate-email required input_field" /><br/>
                    </div>
