...
<head>
	...
	<meta property="og:url" content="https://foodparadise.com/beersecond.php" />
	<meta property="og:title" content="Beer Second" />
...
<body>
	...
	<h1  align="center" style="color:red;"><b>Liquors 2</b></h1></br>
	
	 <?php
					 error_reporting(1);
					 include("connection.php");
						$sel=mysql_query("select * from beersecond ");
 ...
 <b>product name:</b>".$arr['prod_no'].
  ...
  "<br><a href='beersecondorder.php?img=$i'><b>Pick up</b></a>
