...
<head>
	...
	<meta property="og:url" content="https://foodparadise.com/beer.php" />
...
<body>
	...
	<h1  align="center" style="color:red;"><b>Liquors 1</b></h1></br>
	
	 <?php
					 error_reporting(1);
					 include("connection.php");
						$sel=mysql_query("select * from beer ");
 ...
 <b>product name:</b>".$arr['prod_no'].
  ...
  "<br><a href='beerorder.php?img=$i'><b>Pick up</b></a>
