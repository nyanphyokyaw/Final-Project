...
<head>
   ...
   <meta name="keywords" content="Burger, Pizza, Korea Food, Myanmar Food, Liquors">
	...
	<meta property="og:url" content="https://foodparadise.com/myanmar.php" />
...
<body>
	...
	<h1  align="center" style="color:red;"><b>Myanmar Food 1</b></h1></br>
	
	 <?php
					 error_reporting(1);
					 include("connection.php");
						$sel=mysql_query("select * from myanmar ");
 ...
 <b>product name:</b>".$arr['prod_no'].
  ...
  "<br><a href='myanmarorder.php?img=$i'><b>Pick up</b></a>
