...
{
//echo "<script>location.href='accountmyanmarsent.php?prod'</script>";
header("location:accountmyanmarsent.php?order_no=$ordno");  }
...
<head>
	...
	<meta property="og:url" content="https://foodparadise.com/accountmyanmarorder.php" />
	<meta property="og:title" content="Account Myanmar Order" />
...
<body>
	...
	<!-- End header -->
		...
		<div class="container text-center">
			<div class="row">
				<div class="col-lg-12">
					<h1>Myanmar Food 1 Order Form</h1>
				</div>
			</div>
		</div>
	</div>
	...
	<?php
			include("connection.php");
			$sel=mysql_query("select * from myanmar  where img='$i' ");
