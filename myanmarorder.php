...
{
//echo "<script>location.href='myanmarsent.php?prod'</script>";
header("location:myanmarsent.php?order_no=$ordno");  }
...
<head>
	...
	<meta property="og:url" content="https://foodparadise.com/myanmarorder.php" />
	<meta property="og:title" content="Myanmar Order" />
