...
{
//echo "<script>location.href='accountordersent.php?prod'</script>";
header("location:accountordersent.php?order_no=$ordno");  }
...
<head>
	...
	<meta property="og:url" content="https://foodparadise.com/accountorder.php" />
	<meta property="og:title" content="Account Order" />
...
<body>
	...
	<!-- End header -->
		...
		<div class="container text-center">
			<div class="row">
				<div class="col-lg-12">
					<h1>Burger,French Fries,Pizza,Hot Dog,Juice Order Form</h1>
				</div>
			</div>
		</div>
	</div>
