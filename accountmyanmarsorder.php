...
{
//echo "<script>location.href='accountmyanmarssent.php?prod'</script>";
header("location:accountmyanmarssent.php?order_no=$ordno");  }
...
<head>
	...
	<meta property="og:url" content="https://foodparadise.com/myanmarsecondorder.php" />
	<meta property="og:title" content="Myanmar Second Order" />
...
<body>
	...
	<!-- End header -->
		...
		<div class="container text-center">
			<div class="row">
				<div class="col-lg-12">
					<h1>Myanmar Food 2 Order Form</h1>
				</div>
			</div>
		</div>
	</div>
	...
	<?php
			include("connection.php");
			$sel=mysql_query("select * from myanmarsecond  where img='$i' ");
