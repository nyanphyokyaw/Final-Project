...
<head>
	...
	<meta property="og:url" content="https://foodparadise.com/reg_success.php" />
...
<body>
	...
	<!-- End header -->
		...
		<div class="container">
			...
			<br/><br/><br/>
			<p class="t">Welcome!! <?php echo "<font color=blue>".$_REQUEST['name']."</font>"; ?> <br/>
			You have created your account successfully!!!</p>
			
			<p class="t">Thank you for registration.Come To Login.</p>
